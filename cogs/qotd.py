...
class QOTD(commands.Cog):
    ...
    async def qotd(self, inter):
        ...
        if data:
            ...
            db.update_qotd(data[0])
        else:
            await inter.response.send_message("No questions found")
